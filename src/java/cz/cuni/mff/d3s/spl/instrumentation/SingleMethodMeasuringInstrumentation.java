...
import cz.cuni.mff.d3s.spl.instrumentation.javassist.MeasuringSnippets;
import cz.cuni.mff.d3s.spl.instrumentation.javassist.Utils;

class SingleMethodMeasuringInstrumentation implements InstrumentationSnippet {
	private ClassLoaderFilter classloaderFilter;
	private String measurementSiteId;
	private String targetClass;
	private String targetMethod;

	public SingleMethodMeasuringInstrumentation(ClassLoaderFilter loaderFilter,
			String siteId, String klass, String method) {
	...
	private byte[] doInstrument(ClassLoader loader, Class<?> theClass,
		...
		for (CtMethod m : methods) {
			...
			MeasuringSnippets.addMeasuringCodeForSingleMethodInvocation(m, measurementSiteId);
		}
