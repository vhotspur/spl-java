...
public class CallbackInstrumentationTest extends InstrumentationTestBase {
	...
	public void setupBuilder() {
		probeBuilder = new MultimethodInstrumentationProbeControllerBuilder("cz.cuni.mff.d3s.spl.probe.instrument.Action#action",
				"cz.cuni.mff.d3s.spl.probe.instrument.Action#action2");
	}
