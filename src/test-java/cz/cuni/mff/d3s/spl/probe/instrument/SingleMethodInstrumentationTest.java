...
import cz.cuni.mff.d3s.spl.probe.AcceptOnlyOddSizes;
...
public class SingleMethodInstrumentationTest extends InstrumentationTestBase {
	...
	public void setupBuilder() {
		probeBuilder = new InstrumentationProbeControllerBuilder("cz.cuni.mff.d3s.spl.probe.instrument.Action#action");
	}
	...
	public void filteringByClassLoader() throws ReflectiveOperationException {
		...
		Class<?> actionClassDynamic = myLoader.loadClass("cz.cuni.mff.d3s.spl.probe.instrument.Action");
